...
class AssetChartService:
    ...
    def render(
        ...
        try:
            ...
            completed = opened.loc[details["is_bar_complete"]]
            ...
            selected_details = details.loc[details["is_bar_complete"]].iloc[-1]
            metadata["is_bar_complete"] = True
            metadata["completion_reason"] = selected_details["completion_reason"]
            metadata["completion_boundary"] = selected_details["completion_boundary"]
            if requested_sessions is not None:
